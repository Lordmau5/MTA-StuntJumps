class "c_BoundingBoxRenderer" {
	...
	drawBoundingBox = function(self, corner1, corner2, outlineColor, fillColor)
		...
		for i = 1, 4 do
			...
			dxDrawLine3D(corners[i + 4][1], corners[i + 4][2], corners[i + 4][3], corners[i % 4 + 5][1], corners[i % 4 + 5][2],
			             corners[i % 4 + 5][3], outlineColor, outlineThickness) -- Top
			dxDrawLine3D(corners[i][1], corners[i][2], corners[i][3], corners[i + 4][1], corners[i + 4][2], corners[i + 4][3],
			             outlineColor, outlineThickness) -- Verticals
		end
...
BoundingBoxRenderer = c_BoundingBoxRenderer()
